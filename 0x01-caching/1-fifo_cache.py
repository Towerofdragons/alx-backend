...
class FIFOCache(BaseCaching):
    """
        Adds an item to the cache data with the specified key using FIFO replacement policy.
    """
    def __init__(self):
        """
             Calls the parent class (BaseCaching) initializer and sets up additional attributes.
        """
        super().__init__()
        self.key_queue = []
